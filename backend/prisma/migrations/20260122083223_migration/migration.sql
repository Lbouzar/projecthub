...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMMENTED', 'MENTIONED', 'DEADLINE_APPROACHING', 'PROJECT_INVITED', 'MEMBER_JOINED', 'MEMBER_LEFT');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('CREATED', 'UPDATED', 'DELETED', 'MOVED', 'ASSIGNED', 'UNASSIGNED', 'COMMENTED', 'ARCHIVED', 'RESTORED');
